...
| [Links to Presentation PowerPoint, Video Presentation, and Final Report](#links-to-presentation-powerpoint-video-presentation-and-final-report) | Presentation-related materials of this project |
...
- For *clustering analysis*, after manually coded the eight clusters of study, we found significant variance in financial support within the Behavioral and Cognitive Sciences division, with Cognitive Neuroscience receiving the most funding while Archaeology, Phonetics, and Cultural Studies receiving the least. 
...
## Links to Presentation PowerPoint, Video Presentation, and Final Report
